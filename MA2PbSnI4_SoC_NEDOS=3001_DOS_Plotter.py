...
for i in range(1,15):
    Total_read = pd.read_csv(Folder + str(i) + '/' + 'MA2PbSnI4_NEDOS=3001_Subplot_' + Folder + str(i) + '_total_dos.dat', delimiter = ' ')
    Pb_read = pd.read_csv(Folder + str(i) + '/' + 'MA2PbSnI4_NEDOS=3001_Subplot_' +Folder + str(i) + '_Pb_dos.dat', delimiter = ' ')
    Sn_read = pd.read_csv(Folder + str(i) + '/' + 'MA2PbSnI4_NEDOS=3001_Subplot_'+ Folder + str(i) + '_Sn_dos.dat', delimiter = ' ')    
    I_read = pd.read_csv(Folder + str(i) + '/' + 'MA2PbSnI4_NEDOS=3001_Subplot_'+ Folder + str(i) + '_I_dos.dat', delimiter = ' ')    
...
Total = pd.read_csv(Folder + '/' +'MA2PbSnI4_NEDOS=3001_' + Folder + '_Subplot_total_dos.dat', delimiter = ' ')
Sn = pd.read_csv(Folder + '/' +'MA2PbSnI4_NEDOS=3001_' + Folder + '_Subplot_Sn_dos.dat', delimiter = ' ')
I2 = pd.read_csv(Folder + '/' +'MA2PbSnI4_NEDOS=3001_' + Folder + '_Subplot_I_dos.dat', delimiter = ' ')
...
for i in range(1,5):
    ...
    plt.title('MA$_2$Pb$_{0.75}$Sn$_{0.25}$I$_4$ DOS Permutation '+str(i))
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    plt.grid()
    plt.yticks([])
...
for i in range(5,7):
    ...
    plt.title("MA$_2$Pb$_{0.5}$Sn$_{0.5}$I$_4$ DOS 'Columns' Permutation "+str(i-4))
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    plt.grid()
    plt.yticks([])
...
for i in range(7,9):
    ...
    plt.title("MA$_2$Pb$_{0.5}$Sn$_{0.5}$I$_4$ DOS 'Battenberg' Permutation "+str(i-6))
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    plt.grid()
    plt.yticks([])
...
for i in range(11,15):
    ...
    plt.title('MA$_2$Pb$_{0.25}$Sn$_{0.75}$I$_4$ DOS Permutation '+str(i-10))
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    plt.grid()
    plt.yticks([])
